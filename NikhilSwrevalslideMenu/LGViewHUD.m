...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		topLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, offset/2.5, frame.size.width, offset/2)];
		...
		bottomLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, frame.size.height-2*offset/1.75, frame.size.width, offset)];
